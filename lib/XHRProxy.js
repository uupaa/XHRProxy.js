...
//{@dev
    $valid($type(url,      "String") && WMURL.isValid(url), XHRProxy_get, "url");
...
//{@dev
    ...
    $valid($type(url,    "String") && WMURL.isValid(url), XHRProxy_open, "url");
...
function XHRProxy_addEventListener(type,       // @arg EventTypeString - "readystatechange"
                                   callback) { // @arg Function
                                               // @ret this
    this._event["on"](this._lv2 ? this._xhr : null, type, callback);
    return this;
}
...
function XHRProxy_removeEventListener(type,       // @arg EventTypeString - "readystatechange"
                                      callback) { // @arg Function
                                                  // @ret this
    this._event["off"](this._lv2 ? this._xhr : null, type, callback);
    return this;
}
